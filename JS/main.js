...
// let depositMonthsNumber = 6;
// let anualMonthsNumber = 12;
// let annualIncome = (depositAmount*annualRate*(depositMonthsNumber/anualMonthsNumber))/100;
// alert(`Доход по депозитному вкладу за 6 месяцев: ${annualIncome} гривен`);
